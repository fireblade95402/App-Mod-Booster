...
# This script deploys the infrastructure, application, and GenAI resources to Azure

echo "============================================="
echo "Expense Management System Deployment (GenAI)"
echo "============================================="
...
# Deploy infrastructure (App Service, SQL Database, Managed Identity, GenAI)
echo ""
...
echo "Chat UI (with AI): $APP_SERVICE_URL/chatui/index.html"
echo ""
echo "🤖 GenAI Resources Deployed:"
